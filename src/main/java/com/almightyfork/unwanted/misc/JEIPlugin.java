...
//
//        RecipeManager rm2 = Objects.requireNonNull(Minecraft.getInstance().level).getRecipeManager();
//        List<GemInfuserRecipe> recipes1 = rm2.getAllRecipesFor(GemInfuserRecipe.Type.INSTANCE);
//        registration.addRecipes(new RecipeType<>(GemInfuserRecipeCategory.UID, GemInfuserRecipe.class), recipes1);
//
//        RecipeManager rm3 = Objects.requireNonNull(Minecraft.getInstance().level).getRecipeManager();
//        List<TorridFurnaceRecipe> recipes2 = rm3.getAllRecipesFor(TorridFurnaceRecipe.Type.INSTANCE);
