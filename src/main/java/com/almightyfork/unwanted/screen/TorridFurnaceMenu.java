...
import com.almightyfork.unwanted.screen.slot.ModFuelSlot;
...
public class TorridFurnaceMenu extends AbstractContainerMenu {
    private final TorridFurnaceBlockEntity blockEntity;
    ...
    public TorridFurnaceMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            ...
            this.addSlot(new ModResultSlot(handler, 3, 116, 53));
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.TORRID_FURNACE.get());
    }
