...
public class GemCuttingStationScreen extends AbstractContainerScreen<GemCuttingStationMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Unwanted.MODID, "textures/gui/gem_cutting_station_gui.png");

    public GemCuttingStationScreen(GemCuttingStationMenu p_97741_, Inventory p_97742_, Component p_97743_) {
