package com.almightyfork.unwanted.item.trident.wood;
...
@OnlyIn(Dist.CLIENT)
public class ThrownWoodenSpearRenderer extends EntityRenderer<WoodenThrownSpear> {
    public static final ResourceLocation SPEAR_LOCATION = new ResourceLocation(Unwanted.MODID,"textures/entity/wooden_spear_in_hand.png");
    private final SpearModel model;

    public ThrownWoodenSpearRenderer(EntityRendererProvider.Context p_174420_, ModelLayerLocation layerLocation) {
        super(p_174420_);
        this.model = new SpearModel(p_174420_.bakeLayer(layerLocation));
    }

    public void render(WoodenThrownSpear p_116111_, float p_116112_, float p_116113_, PoseStack p_116114_, MultiBufferSource p_116115_, int p_116116_) {
        p_116114_.pushPose();
...
//        VertexConsumer vertexconsumer = p_113843_.getBuffer(RenderType.entityCutout(this.getTextureLocation(p_113839_)));
    ...
    public ResourceLocation getTextureLocation(WoodenThrownSpear p_116109_) {
