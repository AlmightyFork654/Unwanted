...
@OnlyIn(Dist.CLIENT)
public class MechanicalElytraArmorStandLayer extends ElytraLayer<ArmorStand, ArmorStandArmorModel> {
    private static final ResourceLocation TEXTURE_ELYTRA = new ResourceLocation(Unwanted.MODID,
            "textures/models/armor/mechanical_elytra.png");

    public MechanicalElytraArmorStandLayer(ArmorStandRenderer armorStandRenderer,
